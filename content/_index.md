...
sections:
  - block: markdown
    ...
    content:
      ...
      subtitle: ''
      text: |-
        <a class="academic-skip-link" href="#main-content">Skip to content</a>
        <div class="academic-shell">
          <aside class="academic-sidebar" aria-label="Profile and site navigation">
            <h1>Yuanqi Zhang</h1>
            <p class="academic-role">PhD Candidate in Economics<br>University College London<br>Expected 2027</p>
            <hr>
            <nav class="academic-nav" aria-label="Sections">
              <a href="#bio">Bio</a>
          ...
          <main class="academic-main" id="main-content">
            ...
            <section class="academic-section" id="research">
              ...
              <article class="academic-paper">
                <h3><a href="https://arxiv.org/pdf/2607.10043">The Projection Solution to the Incidental Parameter Problem</a></h3>
                <p class="academic-coauthors">with Andrew Chesher and Adam M. Rosen.</p>
                <p class="academic-paper-status"><em>July 2026.</em></p>
              </article>
              <article class="academic-paper">
            ...
            <section class="academic-section" id="contact">
              <h2>Contact</h2>
              <p><strong>Email:</strong> <a href="mailto:uctpyqz@ucl.ac.uk">uctpyqz@ucl.ac.uk</a><br>
              <strong>Affiliation:</strong> Department of Economics, University College London<br>
              <strong>Location:</strong> London, United Kingdom</p>
            </section>
            <p class="academic-footer">© 2026 Yuanqi Zhang</p>
          </main>
        </div>
    design:
      columns: '1'
